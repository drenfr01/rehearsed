...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "Rehearsed")
        ...
        self.LLM_ANSWERING_STUDENT_MODEL = os.getenv("LLM_ANSWERING_STUDENT_MODEL", "gemini-3.1-flash-lite-preview")
        ...
        self.POSTGRES_DB = os.getenv("POSTGRES_DB", "rehearsed")
        ...
        default_endpoints = {
            ...
            "update_agent_personality": ["10 per minute"],
            "delete_agent_personality": ["10 per minute"],
            "get_all_agents": ["10 per minute"],
            "get_agent_by_id": ["10 per minute"],
            "create_agent": ["10 per minute"],
            "update_agent": ["10 per minute"],
            "delete_agent": ["10 per minute"],
            "get_all_feedback": ["10 per minute"],
            "get_feedback_by_id": ["10 per minute"],
            "create_feedback": ["10 per minute"],
            "update_feedback": ["10 per minute"],
            "delete_feedback": ["10 per minute"],
            "create_scenario": ["10 per minute"],
            "update_scenario": ["10 per minute"],
            "delete_scenario": ["10 per minute"],
            "chat": ["30 per minute"],
